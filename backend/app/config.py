...
class Settings(BaseSettings):
    ...
    DEFAULT_SUBTITLE_POSITION: int = 78  # 10% (Top) to 90% (Bottom), default 78% (clean bottom canvas)
    DEFAULT_ADD_HOOK_HEADER: bool = True  # Add sticky persistent TikTok hook title throughout video
    ...
    DEFAULT_REMOVE_WATERMARK: bool = True
    DEFAULT_WATERMARK_POSITION: str = "auto"  # "auto", "top_right", "bottom_right", "top_left", "bottom_left"
    DEFAULT_GENRE: str = "documentary"
    DEFAULT_TARGET_CLIPS: int = 5
    DEFAULT_DURATION_PRESET: str = "60-90s"
